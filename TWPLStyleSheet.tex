...
% If you have any issues with small caps in your documents, please see the note in the font section of the .cls file.
% If you are compiling with XeLaTeX will not need IPA support beyond what is provided by Times New Roman, and you do not want to install the Doulos SIL font for IPA, there is a \documentclass option called ``nodoulos'' that will prevent that font from being loaded.
